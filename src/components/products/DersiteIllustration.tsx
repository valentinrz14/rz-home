interface Props {
  ...
  /** ancho relativo para perspectiva 0-1 */
...
export function DersiteIllustration({
  ...
  return (
    ...
    >
      ...
      <text x="100" y="271" textAnchor="middle" fontSize="7" fill={displayText} fontFamily="monospace">M1</text>
      ...
      <text x="420" y="271" textAnchor="middle" fontSize="7" fill={displayText} fontFamily="monospace">M2</text>
      ...
      <text x="232" y="108" textAnchor="middle" fontSize="14" fontWeight="bold"
            fill={displayText} fontFamily="monospace">71.0</text>
      {/* Botones de memoria */}
      {[0,1,2].map((i) => (
        <g key={i}>
          <rect x={276 + i * 16} y="90" width="12" height="10" rx="2" fill={frameMain} />
          <text x={282 + i * 16} y="99" textAnchor="middle" fontSize="6"
                fill={panelBg} fontFamily="monospace">{i + 1}</text>
        </g>
      ))}
      {/* Botones up/down */}
      <rect x="276" y="104" width="12" height="10" rx="2" fill={isWhite ? "#555" : "#888"} />
      <text x="282" y="113" textAnchor="middle" fontSize="8" fill="white">▲</text>
      <rect x="292" y="104" width="12" height="10" rx="2" fill={isWhite ? "#555" : "#888"} />
      <text x="298" y="113" textAnchor="middle" fontSize="8" fill="white">▼</text>
      ...
      ════════════════════════════════════════════════════════ */}
      <path d="M130,144 Q120,200 115,310" stroke={frameDark} strokeWidth="2.5"
            fill="none" opacity="0.6" strokeDasharray="4 3"/>

      {/* ════════════════════════════════════════════════════════
          GANCHO AURICULARES (derecha del travesaño)
      ════════════════════════════════════════════════════════ */}
      <rect  x="376" y="78"  width="8"  height="18" rx="2" fill={frameMid} />
      <path  d="M380,96 Q390,96 390,106 Q390,116 382,116"
             stroke={frameMid} strokeWidth="4" fill="none" strokeLinecap="round"/>
      ...
      {withTabletop && (
        <>
          ...
          <rect x="55" y="58" width="410" height="10" rx="3"
                fill={tableColorHex} style={{ filter: "brightness(0.7)" }} />
          ...
          />
          {/* Borde tapacanto */}
          <rect x="55" y="26" width="410" height="3" rx="2"
